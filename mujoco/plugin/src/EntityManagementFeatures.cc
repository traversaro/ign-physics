  ...
  const Identity &) const
{
  ...
  static const std::string engineName = "mujoco";
  return engineName;
}
  ...
  const Identity &_worldID, const std::string &_modelName) const
{
  ...
  {
    mujocolib::Entity &modelEnt = worldInfo->world->GetChildByName(_modelName);
  ...
  const Identity &_modelID, const std::string &_modelName) const
{
  ...
  if (modelInfo != nullptr)
  {
    mujocolib::Entity &modelEnt = modelInfo->model->GetChildByName(_modelName);
  ...
  const Identity &_modelID, const std::string &_linkName) const
{
  ...
  if (modelInfo != nullptr)
  {
    mujocolib::Entity &linkEnt = modelInfo->model->GetChildByName(_linkName);
  ...
  const Identity &_linkID, const std::string &_shapeName) const
{
  ...
  if (linkInfo != nullptr)
  {
    mujocolib::Entity &shapeEnt = linkInfo->link->GetChildByName(_shapeName);
...
{
  auto world = std::make_shared<mujocolib::World>();
  world->SetName(_name);
  ...
  const Identity &_worldID, const std::string &_name)
{
  ...
  if (worldInfo != nullptr)
  {
    ...
    mujocolib::Model *model = static_cast<mujocolib::Model *>(&modelEnt);
  ...
  const Identity &_modelID, const std::string &_name)
{
  ...
  if (modelInfo != nullptr)
  {
    ...
    mujocolib::Link *link = static_cast<mujocolib::Link *>(&linkEnt);
