  ...
  const Identity &_boxID) const
{
  ...
  if (it != this->collisions.end() && it->second != nullptr)
  {
    ...
    if (shape != nullptr)
    {
      mujocolib::BoxShape *box = static_cast<mujocolib::BoxShape*>(shape);
...
Identity ShapeFeatures::CastToCylinderShape(const Identity &_shapeID) const
{
  ...
  {
    auto *shape = it->second->collision->GetShape();
    if (shape != nullptr && dynamic_cast<mujocolib::CylinderShape*>(shape))
      return this->GenerateIdentity(_shapeID, it->second);
  }
  return this->GenerateInvalidId();
}
...
Identity ShapeFeatures::CastToCapsuleShape(const Identity &_shapeID) const
{
  ...
  {
    auto *shape = it->second->collision->GetShape();
    if (shape != nullptr && dynamic_cast<mujocolib::CapsuleShape*>(shape))
      return this->GenerateIdentity(_shapeID, it->second);
  }
  return this->GenerateInvalidId();
}
  ...
  const Identity &_capsuleID) const
{
  ...
  if (it != this->collisions.end() && it->second != nullptr)
  {
    ...
    if (shape != nullptr)
    {
      auto *capsule = static_cast<mujocolib::CapsuleShape*>(shape);
  ...
  const Pose3d &_pose)
{
  ...
  if (it != this->links.end() && it->second != nullptr)
  {
    ...
    mujocolib::CapsuleShape capsuleshape;
  ...
  const Identity &_cylinderID) const
{
  ...
  if (it != this->collisions.end() && it->second != nullptr)
  {
    ...
    if (shape != nullptr)
    {
      auto *cylinder = static_cast<mujocolib::CylinderShape*>(shape);
  ...
  const Pose3d &_pose)
{
  ...
  if (it != this->links.end() && it->second != nullptr)
  {
    ...
    mujocolib::CylinderShape cylindershape;
...
Identity ShapeFeatures::CastToEllipsoidShape(const Identity &_shapeID) const
{
  ...
  {
    auto *shape = it->second->collision->GetShape();
    if (shape != nullptr && dynamic_cast<mujocolib::EllipsoidShape*>(shape))
      return this->GenerateIdentity(_shapeID, it->second);
  }
  return this->GenerateInvalidId();
}
  ...
  const Identity &_capsuleID) const
{
  ...
  if (it != this->collisions.end() && it->second != nullptr)
  {
    ...
    if (shape != nullptr)
    {
      auto *capsule = static_cast<mujocolib::EllipsoidShape*>(shape);
  ...
  const Pose3d &_pose)
{
  ...
  if (it != this->links.end() && it->second != nullptr)
  {
    ...
    mujocolib::EllipsoidShape capsuleshape;
  ...
  const Identity &_shapeID) const
{
  ...
  {
    auto *shape = it->second->collision->GetShape();
    if (shape != nullptr && dynamic_cast<mujocolib::SphereShape*>(shape))
      return this->GenerateIdentity(_shapeID, it->second);
  }
  return this->GenerateInvalidId();
}
...
double ShapeFeatures::GetSphereShapeRadius(const Identity &_sphereID) const
{
  ...
  if (it != this->collisions.end() && it->second != nullptr)
  {
    ...
    if (shape != nullptr)
    {
      auto *sphere = static_cast<mujocolib::SphereShape*>(shape);
  ...
  const Pose3d &_pose)
{
  ...
  if (it != this->links.end() && it->second != nullptr)
  {
    ...
    mujocolib::SphereShape sphereshape;
  ...
  const Identity &_shapeID) const
{
  ...
  {
    auto *shape = it->second->collision->GetShape();
    if (shape != nullptr && dynamic_cast<mujocolib::MeshShape*>(shape))
      return this->GenerateIdentity(_shapeID, it->second);
  }
  return this->GenerateInvalidId();
}
  ...
  const Identity &_meshID) const
{
  ...
  if (it != this->collisions.end() && it->second != nullptr)
  {
    ...
    if (shape != nullptr)
    {
      auto *mesh = static_cast<mujocolib::MeshShape*>(shape);
