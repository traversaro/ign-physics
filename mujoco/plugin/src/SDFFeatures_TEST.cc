...
struct TestFeatureList : ignition::physics::FeatureList<
    ignition::physics::mujocoplugin::RetrieveWorld,
...
auto LoadEngine()
{
  ...
  ignition::plugin::PluginPtr mujoco_plugin =
      loader.Instantiate("ignition::physics::mujocoplugin::Plugin");

  auto engine =
      ignition::physics::RequestEngine3d<TestFeatureList>::From(mujoco_plugin);
  return engine;
}
...
TEST(SDFFeatures_TEST, CheckmujocoData)
{
  World world = LoadWorld(TEST_WORLD_DIR"/test.world");
  auto mujocoWorld = world.GetmujocoWorld();
  ASSERT_NE(nullptr, mujocoWorld);

  ASSERT_EQ(6u, mujocoWorld->GetChildCount());

  // check model 01
  {
    ignition::physics::mujocolib::Entity &model =
        mujocoWorld->GetChildByName("ground_plane");
    ASSERT_NE(ignition::physics::mujocolib::Entity::kNullEntity.GetId(),
        model.GetId());
    ...
    ignition::physics::mujocolib::Entity &link = model.GetChildByName("link");
    ASSERT_NE(ignition::physics::mujocolib::Entity::kNullEntity.GetId(),
        link.GetId());
    ...
    ignition::physics::mujocolib::Entity &collision =
  ...
  {
    ignition::physics::mujocolib::Entity &model =
        mujocoWorld->GetChildByName("double_pendulum_with_base");
    ASSERT_NE(ignition::physics::mujocolib::Entity::kNullEntity.GetId(),
        model.GetId());
    ...
    ignition::physics::mujocolib::Entity &link = model.GetChildByName("base");
    ASSERT_NE(ignition::physics::mujocolib::Entity::kNullEntity.GetId(),
        link.GetId());
    ...
    ignition::physics::mujocolib::Entity &collision02 =
    ...
    ignition::physics::mujocolib::Entity &link02 =
    ...
    ignition::physics::mujocolib::Entity &collision03 =
    ...
    ignition::physics::mujocolib::Entity &collision04 =
    ...
    ignition::physics::mujocolib::Entity &collision05 =
    ...
    ignition::physics::mujocolib::Entity &link03 =
    ...
    ignition::physics::mujocolib::Entity &collision06 =
    ...
    ignition::physics::mujocolib::Entity &collision07 =
  ...
  {
    ignition::physics::mujocolib::Entity &model =
        mujocoWorld->GetChildByName("free_body");
    ASSERT_NE(ignition::physics::mujocolib::Entity::kNullEntity.GetId(),
        model.GetId());
  ...
  {
    ignition::physics::mujocolib::Entity &model =
        mujocoWorld->GetChildByName("joint_limit_test");
    ASSERT_NE(ignition::physics::mujocolib::Entity::kNullEntity.GetId(),
        model.GetId());
    ...
    ignition::physics::mujocolib::Entity &link02 = model.GetChildByName("bar");
    ASSERT_NE(ignition::physics::mujocolib::Entity::kNullEntity.GetId(),
        link02.GetId());
  ...
  {
    ignition::physics::mujocolib::Entity &model =
        mujocoWorld->GetChildByName("screw_joint_test");
    ASSERT_NE(ignition::physics::mujocolib::Entity::kNullEntity.GetId(),
        model.GetId());
    ...
    ignition::physics::mujocolib::Entity &link = model.GetChildByName("link0");
    ASSERT_NE(ignition::physics::mujocolib::Entity::kNullEntity.GetId(),
        link.GetId());
    ...
    ignition::physics::mujocolib::Entity &link02 = model.GetChildByName("link1");
    ASSERT_NE(ignition::physics::mujocolib::Entity::kNullEntity.GetId(),
        link02.GetId());
  ...
  {
    ignition::physics::mujocolib::Entity &model =
        mujocoWorld->GetChildByName("unsupported_joint_test");
    ASSERT_NE(ignition::physics::mujocolib::Entity::kNullEntity.GetId(),
        model.GetId());
    ...
    ignition::physics::mujocolib::Entity &link03 = model.GetChildByName("link2");
    ASSERT_NE(ignition::physics::mujocolib::Entity::kNullEntity.GetId(),
        link03.GetId());
    ...
    ignition::physics::mujocolib::Entity &link04 = model.GetChildByName("link3");
    ASSERT_NE(ignition::physics::mujocolib::Entity::kNullEntity.GetId(),
        link04.GetId());
    ...
    ignition::physics::mujocolib::Entity &link05 = model.GetChildByName("link4");
    ASSERT_NE(ignition::physics::mujocolib::Entity::kNullEntity.GetId(),
        link05.GetId());
    ...
    ignition::physics::mujocolib::Entity &link06 = model.GetChildByName("link5");
    ASSERT_NE(ignition::physics::mujocolib::Entity::kNullEntity.GetId(),
        link06.GetId());
...
// Test that the mujoco plugin loaded nested models correctly.
TEST(SDFFeatures_TEST, NestedModel)
{
  ...
  ASSERT_EQ(1u, mujocoWorld->GetChildCount());
  EXPECT_EQ(1u, world.GetModelCount());

  // check top level model
  ignition::physics::mujocolib::Entity &model =
      mujocoWorld->GetChildByName("model");
  ASSERT_NE(ignition::physics::mujocolib::Entity::kNullEntity.GetId(),
      model.GetId());
  ...
  // check nested model
  ignition::physics::mujocolib::Entity &nestedModel =
  ...
  ignition::physics::mujocolib::Entity &nestedLink =
  ...
  ignition::physics::mujocolib::Entity &nestedCollision =
  ...
  // canonical link
  ignition::physics::mujocolib::Model *m =
      static_cast<ignition::physics::mujocolib::Model *>(&model);
  ignition::physics::mujocolib::Entity canLink = m->GetCanonicalLink();
