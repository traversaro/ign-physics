...
#ifndef IGNITION_PHYSICS_MUJOCO_PLUGIN_SRC_SIMULATIONFEATURES_HH_
#define IGNITION_PHYSICS_MUJOCO_PLUGIN_SRC_SIMULATIONFEATURES_HH_
  ...
  public virtual Implements3d<SimulationFeatureList>
{
  ...
  private: mujocolib::Entity &GetModelCollision(std::size_t _id) const;
