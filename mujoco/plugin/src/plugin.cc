...
struct mujocoPluginFeatures : FeatureList<
  CustomFeatureList,
...
class Plugin :
  public virtual Implements3d<mujocoPluginFeatures>,
  public virtual Base,
...
IGN_PHYSICS_ADD_PLUGIN(Plugin, FeaturePolicy3d, mujocoPluginFeatures)
