...
struct TestFeatureList : ignition::physics::FeatureList<
  ignition::physics::mujocoplugin::SimulationFeatureList,
  ignition::physics::mujocoplugin::ShapeFeatureList,
  ignition::physics::mujocoplugin::EntityManagementFeatureList,
  ignition::physics::mujocoplugin::FreeGroupFeatureList,
