...
TEST(BaseClass, AddEntities)
{
  ...
  auto *model1 = static_cast<mujocolib::Model *>(&modelEnt1);
  ...
  auto *model2 = static_cast<mujocolib::Model *>(&modelEnt2);
  ...
  auto *link1 = static_cast<mujocolib::Link *>(&linkEnt1);
  ...
  auto *link2 = static_cast<mujocolib::Link *>(&linkEnt2);
  ...
  auto *box = static_cast<mujocolib::Collision *>(&boxEnt);
  ...
  auto *cylinder = static_cast<mujocolib::Collision *>(&cylinderEnt);
