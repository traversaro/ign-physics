...
#ifndef IGNITION_PHYSICS_MUJOCO_LIB_SRC_LINK_HH_
#define IGNITION_PHYSICS_MUJOCO_LIB_SRC_LINK_HH_
...
/// \brief Link class
class IGNITION_PHYSICS_MUJOCOLIB_VISIBLE Link : public Entity
{
  /// \brief Constructor
  public: Link();
  ...
  public: void SetInertialParameters(const math::Inertiald &_inertialParameters);

  public: math::Inertiald GetInertialParameters() const;
  ...
  protected: math::Inertiald inertialParameters;

  // Id that identifies the body in mujoco data structures
  public: std::size_t mujocoId = 0;
