...
#ifndef IGNITION_PHYSICS_MUJOCO_LIB_SRC_COLLISION_HH_
#define IGNITION_PHYSICS_MUJOCO_LIB_SRC_COLLISION_HH_
...
class IGNITION_PHYSICS_MUJOCOLIB_VISIBLE Collision : public Entity
{
  /// \brief Constructor
  public: Collision();
