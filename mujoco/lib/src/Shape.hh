...
#ifndef IGNITION_PHYSICS_MUJOCO_LIB_SRC_SHAPE_HH_
#define IGNITION_PHYSICS_MUJOCO_LIB_SRC_SHAPE_HH_
...
enum class IGNITION_PHYSICS_MUJOCOLIB_VISIBLE ShapeType
{
...
class IGNITION_PHYSICS_MUJOCOLIB_VISIBLE Shape
{
  /// \brief Constructor
  public: Shape();
...
/// \brief Box geometry
class IGNITION_PHYSICS_MUJOCOLIB_VISIBLE BoxShape : public Shape
{
  /// \brief Constructor
  public: BoxShape();
...
class IGNITION_PHYSICS_MUJOCOLIB_VISIBLE CapsuleShape : public Shape
{
  /// \brief Constructor
  public: CapsuleShape();
...
class IGNITION_PHYSICS_MUJOCOLIB_VISIBLE CylinderShape : public Shape
{
  /// \brief Constructor
...
class IGNITION_PHYSICS_MUJOCOLIB_VISIBLE EllipsoidShape : public Shape
{
  /// \brief Constructor
...
class IGNITION_PHYSICS_MUJOCOLIB_VISIBLE SphereShape : public Shape
{
  /// \brief Constructor
  public: SphereShape();
...
/// \brief Mesh geometry
class IGNITION_PHYSICS_MUJOCOLIB_VISIBLE MeshShape : public Shape
{
  /// \brief Constructor
  public: MeshShape();
