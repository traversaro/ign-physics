...
#ifndef IGNITION_PHYSICS_MUJOCO_LIB_SRC_COLLISIONDETECTOR_HH_
#define IGNITION_PHYSICS_MUJOCO_LIB_SRC_COLLISIONDETECTOR_HH_
...
class IGNITION_PHYSICS_MUJOCOLIB_VISIBLE Contact
{
...
class IGNITION_PHYSICS_MUJOCOLIB_VISIBLE CollisionDetector
{
  /// \brief Constructor
