...
#ifndef IGNITION_PHYSICS_MUJOCO_LIB_SRC_AABBTREE_HH_
#define IGNITION_PHYSICS_MUJOCO_LIB_SRC_AABBTREE_HH_
...
class IGNITION_PHYSICS_MUJOCOLIB_VISIBLE AABBTree
{
  /// \brief Constructor
  public: AABBTree();
