...
#ifndef IGNITION_PHYSICS_MUJOCO_LIB_SRC_WORLD_HH_
#define IGNITION_PHYSICS_MUJOCO_LIB_SRC_WORLD_HH_
...
/// \brief World Class
class IGNITION_PHYSICS_MUJOCOLIB_VISIBLE World : public Entity
{
  /// \brief Constructor
  public: World();
  ...
  protected: void RegeneratedMuJoCoDataStructures();
  ...
  /// \brief If true, the MuJoCo data structures needs to be regenerated
  protected: bool MuJoCoNeedsToBeRegenerated = true;

  protected: mjModel* mujocoModelPtr = NULL;

  protected: mjData* mujocoDataPtr = NULL; 
