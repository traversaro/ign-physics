...
//////////////////////////////////////////////////
void Link::SetInertialParameters(const math::Inertiald &_inertialParameters)
{
  this->inertialParameters = _inertialParameters;
}

//////////////////////////////////////////////////
math::Inertiald Link::GetInertialParameters() const
{
  return this->inertialParameters;
}
